...
import { Settings, Users, Building2, Package2, Plus, CreditCard as Edit, Trash2, Save, X, Layout, ChevronDown, ChevronRight, Eye, UserPlus, Grid, Box } from 'lucide-react';
...
export const Administration: React.FC = () => {
  ...
  const WarehouseForm = ({ warehouse, onSave, onCancel }: any) => {
                  ...
                  <div key={warehouse.id} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex space-x-1">
                        ...
                        <button
                          onClick={() => setEditingItem(warehouse)}
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {usersList.map(u => (
                      <tr key={u.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 cursor-pointer" onClick={() => setEditingItem(u)}>Edit</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
