...
export const InventoryManagement: React.FC = () => {
  ...
  const loadData = () => {
    ...
    const filteredAssets = user?.role === 'super_admin'
      ? allAssets
                ...
                return (
                  <tr key={asset.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        <div className="text-sm font-medium text-gray-900">{asset.productType}</div>
                        <div className="text-sm text-gray-500 font-mono">{asset.qrCode}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center text-sm text-gray-900">
                        ...
                        {warehouseName} {'>'} {sectionName} {'>'} {trayName}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
