    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {Object.entries(reportData.agingBuckets).map(([bucket, count]) => (
          <div key={bucket} className="bg-white p-4 rounded-lg border border-gray-200 text-center">
  ...
  const renderMovementReport = () => (
    <div className="space-y-6">
      <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <div className="text-sm text-gray-600">Total Events (Last {dateRange} days)</div>
      </div>
