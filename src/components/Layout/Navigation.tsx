...
export const Navigation: React.FC<NavigationProps> = ({ activeTab, onTabChange }) => {
  ...
  const navigationItems = [
    ...
    { id: 'productList', label: 'Product List', icon: BoldIcon, roles: ['admin', "manager", 'staff'] },
    { id: 'orderHistory', label: 'Orders History', icon: ListOrdered, roles: ['admin', 'warehouse_manager', 'manager', 'staff'] },
